...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    var $form = $('form');
	    var $input1 = $form.find('input:nth-child(1)');
	    var $input2 = $form.find('input:nth-child(2)');
	    ...
	    function handler($this) {
	        try {
	            ...
	            // Build truth table.
	            var calc = new _logicCalculator2.default(text);

	            var info = {};
	            var truthTable = calc.truthTable();
	            ...
	            info.selfDual = calc.isSelfDual() ? 'Self dual function.' : 'Not self dual function.';

	            var text2 = $this.siblings('input').val();
	            if (text2.length !== 0) {
	                info.dual = calc.isDual(new _logicCalculator2.default(text2).truthTable());
	            }
	            ...
	            if (e.name === 'SyntaxError') {
	                text = e.location.start.line + '.' + e.location.start.column + ': ' + ('' + e.message);
	            }

	            $alert.addClass('alert-danger').text(text);
	...
	var LogicCalculator = (function () {
	    ...
	    _createClass(LogicCalculator, [{
	        ...
	        value: function mcnf() {
	            ...
	            var tmp = this._pcnf.replace(/[a-zA-Z][a-zA-Z0-9]*/g, '1').replace(/![a-zA-Z][a-zA-Z0-9]*/g, '0').replace(/[\(\)|]/g, '').split('&');
	        ...
	        key: 'isCover',
	        value: function isCover(prime, imp) {
